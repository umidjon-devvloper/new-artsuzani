...
export default async function Home() {
  ...
  const categoryList =
    "data" in (category as any)
      ? JSON.parse(JSON.stringify((category as any).data))
      : [];
  ...
  return (
    <div className=" min-h-screen relative z-0">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
        <svg
          className="absolute top-0 left-0 w-[400px] h-[400px] text-primary/5 sm:w-[600px] sm:h-[600px]"
          viewBox="0 0 200 200"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            fill="currentColor"
            d="M100 0C155.228 0 200 44.7715 200 100C200 155.228 155.228 200 100 200C44.7715 200 0 155.228 0 100C0 44.7715 44.7715 0 100 0ZM50 100L100 50L150 100L100 150L50 100Z"
          />
        </svg>
        <svg
          className="absolute top-[30%] right-[-10%] w-[500px] h-[500px] text-secondary/10 transform rotate-45"
          viewBox="0 0 200 200"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
        ...
        <svg
          className="absolute bottom-10 left-[10%] w-64 h-64 text-accent/5"
          viewBox="0 0 100 100"
          xmlns="http://www.w3.org/2000/svg"
        >
          <rect
      ...
      <main className="pt-24 px-4  w-full mx-auto relative z-10">
        <section aria-labelledby="hero" className="mb-16 z-10">
          ...
          <div className="w-full overflow-hidden">
            ...
            <DynamicHeroCarousel className="rounded-[32px] shadow-2xl/50 ring-1 ring-white/20 backdrop-blur-sm" />
          </div>
        </section>
